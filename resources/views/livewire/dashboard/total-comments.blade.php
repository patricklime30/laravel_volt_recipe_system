...
new class extends Component {
    ...
    public $increase = 0;
     ...
     public function mount(){
        ...
        // this week
        $this->thisWeekData = Comment::selectRaw('DATE(created_at) as day, COUNT(*) as count')
                                ->whereIn('recipe_id', $recipe)
        ...
        // last week
        $this->lastWeekData = Comment::selectRaw('DATE(created_at) as day, COUNT(*) as count')
                                ->whereIn('recipe_id', $recipe)
        ...
        $this->total = Comment::whereIn('recipe_id', $recipe)->count();
    ...
    <div class="flex items-center justify-between">
        ...
        <div class="relative group">
            ...
            <div class="absolute right-0 mt-2 w-56 rounded-md bg-indigo-600 text-white text-xs p-2 opacity-0 
                ...
                Total comments received this week by this user.
            </div>
        </div>
    </div>
