...
new class extends Component {
    ...
    public function updateRecipe()
    {
        ...
        return redirect()->route('recipe.show', $this->recipe->id)->with('success', 'Recipe updated successfully!');
    }
}; ?>
    ...
    <form wire:submit="updateRecipe" class="space-y-6">
        ...
        <div class="flex flex-col md:flex-row gap-6 items-start">
            ...
            <div class="w-full md:w-40">
                ...
                @else
                    <img src="{{ asset('storage/'. $existingImage) }}" class="mt-2 w-full h-32 object-cover rounded">
                @endif
            </div>
        ...
        <div class="flex gap-4">
            ...
            <x-secondary-button wire:navigate href="{{ route('recipe.show', $recipe) }}">
                Cancel
            </x-secondary-button>
        </div>
